%% Comparison of performance original MDICC to our approach
...
original_mdicc_lihc = readmatrix('C:\Users\floor\OneDrive\Documents\MDICC\MDICC-main\MDICC-main\lihc\scores_km_lihc.csv');
original_mdicc_lihc = original_mdicc_lihc(2:3,2);
...
original_mdicc_kirc = readmatrix('C:\Users\floor\OneDrive\Documents\MDICC\MDICC-main\MDICC-main\kirc\scores_km_kirc.csv');
original_mdicc_kirc = original_mdicc_kirc(2:3,2);
...
%% Calculate average precision of the optimal precision value of the datsets
...
yl1 = yline(original_mdicc_lihc(1,1), 'b', 'ARI Kmeans');
yl2 = yline(original_mdicc_lihc(2,1), 'r', 'NMI Kmeans');
...
% add horizontal lines (scores using Kmeans++) to plot
yl1 = yline(original_mdicc_kirc(1,1), 'b', 'ARI Kmeans');
yl2 = yline(original_mdicc_kirc(2,1), 'r', 'NMI Kmeans');
yl1.LabelVerticalAlignment = 'top';
yl1.LabelHorizontalAlignment = 'left';
yl2.LabelVerticalAlignment = 'bottom';
yl2.LabelHorizontalAlignment = 'left';
...
sgtitle('Comparison of original MDICC to our model')

% save figure as pdf file
exportgraphics(fig,'C:\Users\floor\OneDrive\Documents\MDICC\MDICC-main\MDICC-main\comparisons\comparison4.pdf','ContentType','vector')